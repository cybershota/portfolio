  ...
  <div>
        ...
        <div class="logo">
          <nuxt-link to="/">
            <h1 class="text-2xl font-semibold text-gray-700">
              <span class="text-primary font-bold">zang</span>wang.
            </h1>
          </nuxt-link>
        </div>
    ...
    <div :class="[isOpen ? '' : 'hidden', 'md:hidden']">
      <div class="px-2 pt-2 pb-3 sm:px-3 bg-primary">
        <!-- <nuxt-link to="portfolio" class="mobile-link focus:outline-none hover:text-gray-500"
          >Projects
        </nuxt-link> -->
        <!-- <nuxt-link to="blog" class="mt-1 mobile-link focus:outline-none hover:text-gray-500"
          >Blog
        </nuxt-link> -->
        <nuxt-link to="about" class="mt-1 mobile-link focus:outline-none hover:text-gray-500"
          >About
        </nuxt-link>
