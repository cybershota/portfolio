<template>
  <div class="wrapper-small text-center md:px-10">
    <div class="text-center mt-2 border-b-2 pb-10">
      <h3 class="text-xl md:text-2xl lg:text-3xl text-gray-700 font-semibold">About Me.</h3>
    </div>
    <img class="mx-auto my-10 max-w-avatar rounded-full " src="https://i.imgur.com/WV2eVM9.png" />
    <p class="text-justify text-base md:text-lg font-medium text-gray-700 mt-2 px-14 my-4">
    ...
    <div class="mt-10">
      <a
        href="https://www.cakeresume.com/zangwang-resume"
        target="_blank"
        class="bg-indigo-600 hover:bg-indigo-700 px-3 py-4 px-6 text-md text-gray-200 font-semibold font-medium rounded-full"
        >Resume</a
      >
    </div>
  </div>
